...
var ni = $.get("organigrama/"+root.id,function(response){
...
//alert(JSON.stringify(response));
            ...
            if (root.iddependencia == dep) {
                ...
                items.push("<li class='unic" + root.id + " root' id='" + root.nombre + "'><span class='label_node'><a href=''>" + root.nombre + "</a></br><i>" + root.unidad + "</i></span><div class='details'><p><strong>Nivel: </strong>" + root.nivel_id + "</p><p><strong>Departmento: </strong>" + root.nivel_name + "</p></div>");
            } else {

                items.push("<li class='child unic" + root.id + "' id='" + root.nombre + "'><span class='label_node'><a href=''>" + root.nombre + "</a></br><i>" + root.unidad + "</i></span><div class='details'><p><strong>Nivel: </strong>" + root.nivel_id + "</p><p><strong>Departmento: </strong>" + root.nivel_name + "</p></div>");
